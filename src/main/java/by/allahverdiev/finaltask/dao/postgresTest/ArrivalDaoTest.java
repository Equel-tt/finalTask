...
public class ArrivalDaoTest extends ArrivalDaoPg {
    private static final Logger logger = LogManager.getLogger(ArrivalDaoTest.class);
    ...
    public ArrivalDaoTest(Connection newConnection) {
        this.connection = newConnection;
    }

    private static final String SQL_SELECT_ALL_ARRIVALS_IN_PERIOD =
            "SELECT * " +
                    "FROM manufacturetest.public.arrival " +
    ...
    private static final String SQL_DELETE_ARRIVAL_BY_DOC_AND_PRODUCT =
            "DELETE FROM manufacturetest.public.arrival " +
