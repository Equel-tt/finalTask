...
public class ConsumptionDaoTest extends ConsumptionDaoPg {
    private static final Logger LOGGER = LogManager.getLogger(ConsumptionDaoTest.class);
    ...
    public ConsumptionDaoTest() {
    }

    public ConsumptionDaoTest(Connection connection) {
        this.connection = connection;
    }

    private static final String SQL_SELECT_ALL_CONSUMPTION_IN_TIME_PERIOD =
            "SELECT * " +
                    "FROM manufacturetest.public.consumption " +
