...
public class NeedDaoTest extends NeedDaoPg {
    private static final Logger logger = LogManager.getLogger(NeedDaoTest.class);
    ...
    public NeedDaoTest(Connection newConnection) {
        this.connection = newConnection;
    }

    private static final String SQL_SELECT_ALL_NEED =
            "SELECT * " +
                    "FROM manufacturetest.public.need ";
