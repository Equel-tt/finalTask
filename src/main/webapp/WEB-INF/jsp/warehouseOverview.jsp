...
<table class="table table-bordered table-hover container-sm" id="tableForSort">
    <thead>
    <tr class="bg-success">
        <th onclick="sortTable(0)" class="col-sm-1"><fmt:message key="product.id" bundle="${bundle}"/></th>
        <th onclick="sortTable(1)" class="col-sm-3"><fmt:message key="product.name" bundle="${bundle}"/></th>
        <th onclick="sortTable(2)" class="col-sm-1"><fmt:message key="product.count" bundle="${bundle}"/></th>
    </tr>
    </thead>
    <tbody>
